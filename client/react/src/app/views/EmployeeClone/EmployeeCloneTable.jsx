...
import EmployeeCloneEditorDialog from "./EmployeeCloneEditorDialog";
...
class EmployeeCloneTable extends Component {
  state = {
    rowsPerPage: 10,
    page: 0,
    itemList: [],
  ...
  render() {
    ...
    let columns = [
      ...
      // },
      { title: t("employee.name"), field: "name", align: "left", width: "150" },
      { title: t("employee.code"), field: "code", align: "left", width: "150" },
      { title: t("employee.email"), field: "email", align: "left", width: "150" },
      { title: t("employee.phone"), field: "phone", align: "left", width: "150" },
...
export default EmployeeCloneTable
